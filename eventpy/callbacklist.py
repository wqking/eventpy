import eventpy.internal.lock as lock
import eventpy.internal.linkedlist as linkedlist

class CallbackList :
    def __init__(self, lockClass = None) :
        self._lockClass = lockClass
        if self._lockClass == None :
            self._lockClass = lock.Lock
        self._list = linkedlist.LinkedList(self._lockClass())
